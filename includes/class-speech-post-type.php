...
final class Speech_Post_Type {
		...
		foreach ( $this->metadata() as $key => $type ) {
			$rest_visible = ! in_array(
				...
				array(
					'_mdb_download_url',
					'_mdb_attachment_id',
					'_mdb_subtitle_attachment_id',
					'_mdb_subtitle_checked_at',
					'_mdb_subtitle_error',
					'_mdb_sync_status',
					'_mdb_last_seen',
					'_mdb_last_error',
	...
	private function metadata(): array {
		return array(
			...
			'_mdb_subtitle_attachment_id' => 'integer',
			'_mdb_subtitle_source_url' => 'string',
			'_mdb_subtitle_checked_at' => 'string',
			'_mdb_subtitle_error'     => 'string',
